...
if (isset($_POST['submit'])) {
    ...
    if ($insert) {
        $alert = "Berhasil Registrasi"; $_SESSION['message'] = $alert; header("Location: nurul_register.php"); exit();
    } else {
        $alert = "Gagal Registrasi"; $_SESSION['message'] = $alert; header("Location: nurul_register.php"); exit();
    }
}
?>
    ...
    <div class="row justify-content-center d-flex">
        <div class="col-5  justify-content-center align-middle">
            <div class="card">
                ...
                <hr/>
                    <form action="nurul_register.php" method="post">
                        ...
                        <div class="form-group mb-3 text-center">
                            <p class="d-inline">Anda sudah punya akun? </p><a href="nurul_login.php" class="">Login</a>
                        </div>
                    </form>
                </div>
            </div>
