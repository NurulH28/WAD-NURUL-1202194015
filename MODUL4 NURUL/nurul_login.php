                ...
                if (isset($_POST['btn_login'])){
                    ...
                    if ($logged->num_rows >= 1) {
                        ...
                        $alert = "Gagal Login"; $_SESSION['message'] = $alert; header('Location: nurul_login.php'); exit();
                    }
                }
                ?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-5  justify-content-center align-middle">
                                <div class="card">
                                    ...
                                    <h4 class="text-decoration-none"><center>Login</center></h4>
                                    <hr/>
                                        <?php
                                        ...
                                        ?>
                                        <form action="nurul_login.php" method="post">
                                            <div class="form-group mb-3">
                                                <label for="e-mail">Email</label>
                                                <input type="email" required class="form-control" name="email" placeholder="Masukkan Alamat E-mail" id="e-mail" value="<?php echo $saved_email ?>">
                                            </div>
                                            <div class="form-group mb-3">
                                                <label for="passw">Kata Sandi</label>
                                                <input type="password" required class="form-control" name="passw" placeholder="Kata Sandi Anda" id="passw" value="<?php echo $saved_password ?>">
                                            </div>
                                            <div class="form-group mb-3">
                                            ...
                                            <p class="d-inline">Anda belum punya akun? </p><a href="nurul_register.php">Register </a>
                                        </div>
                                        </form>
                                    </div>
                                </div>
