                        ...
                        if (!isset($_SESSION['logged_in'])) {
                            header('location: nurul_login.php');
                        }
                        if (isset($_POST['btn_logout'])) {
                            session_destroy(); header('Location: nurul_login.php'); exit();
                        }
                        if (isset($_GET['id'])) {
                            if ($_GET['id'] == $_SESSION['id']) {
                                ...
                                header('location: nurul_profile.php?id=' . $_SESSION["id"]);
                            }
                        } else {
                                ...
                                <div class="row justify-content-center d-flex h-100">
                                    <div class="col-10 mt-5">
                                        <div class="card border-0">
                                            ...
                                            <div class="card-body">
                                                <form action="nurul_profile.php?id=<?php echo $name["id"] ?>" method="post">
                                                    ...
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="password" class="form-control form-inline" placeholder="Kata Sandi" name="passw" id="passw">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-4">
                                                        <label for="conf_passw" class="col-sm-2 col-form-label">Konfirmasi Kata Sandi</label>
                                                        <div class="col-sm-10">
                                                            <input type="password" class="form-control form-inline" placeholder="Konfirmasi Kata Sandi" name="conf_passw" id="conf_passw">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-4">
