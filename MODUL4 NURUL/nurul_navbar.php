...
<nav class="navbar navbar-expand-lg navbar-light <?php echo $latar ?>" style="background: #a4c0f3;">
    ...
    <div style="margin-right: 130px; padding-right:120px;">
        <ul class="navbar-nav">
            ...
            ?>
                <li class="nav-item">
                    <a class="nav-link" href="nurul_register.php">Register</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="nurul_login.php">Login</a>
                </li>
            <?php
            } else {
            ?>
                <li class="nav-item">
                    <a class="nav-link" href="nurul_bookings.php"><i class="fa fa-shopping-cart"></i></a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="nurul_profile.php?id=<?php echo $_SESSION['id'] ?>">Profile</a></li>
                        <li>
