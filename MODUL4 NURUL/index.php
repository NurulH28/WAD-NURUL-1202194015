                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="index.php" method="post">
                                                                    <input type="hidden" name="nama_tempat" value="<?php echo $psn['nama_tempat'] ?>">
                                                                    <input type="hidden" name="lokasi" value="<?php echo $psn['lokasi'] ?>">
                                                                    <input type="hidden" name="harga" value="<?php echo $psn['harga'] ?>">
                                                                    <input placeholder="masukkan tanggal Akhir" type="date" name="tanggal" class="form-control mb-3" name="tgl_akhir" required>
                                                                    <div style="margin-left: 360px;">
                                                                        <button class="btn btn-block btn-primary" name="btn_add" type="submit">Tambahkan</button>
                                                                    </div>
                                                                </form>
